...
class AppTextStyles {
  ...
  static const TextStyle text14WhiteBold = TextStyle(
    fontSize: 14,
    color: AppColors.white,
    fontWeight: FontWeight.bold,
    fontFamily: 'Janna-LT',
  ...
  static const TextStyle text16WhiteBold = TextStyle(
    fontSize: 16,
    color: AppColors.white,
    fontWeight: FontWeight.bold,
    fontFamily: 'Janna-LT',
  ...
  static const TextStyle text36WhiteBold = TextStyle(
    fontSize: 36,
    color: AppColors.white,
    fontWeight: FontWeight.bold,
    fontFamily: 'Janna-LT',
  ...
  static const TextStyle text20GoldBold = TextStyle(
    fontSize: 20,
    color: AppColors.gold,
    fontWeight: FontWeight.bold,
    fontFamily: 'Janna-LT',
  ...
  static const TextStyle text24GoldBold = TextStyle(
    fontSize: 24,
    color: AppColors.gold,
    fontWeight: FontWeight.bold,
    fontFamily: 'Janna-LT',
